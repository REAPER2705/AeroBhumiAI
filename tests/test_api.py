...
class TestBuildCheckEndpoint:
    ...
    def valid_house_inside(self):
        ...
        return {
            "type": "Polygon",
            "coordinates": [
                [[79.0805, 21.1402], [79.0808, 21.1402], [79.0808, 21.1405], [79.0805, 21.1405], [79.0805, 21.1402]]
            ]
        }
    ...
    def valid_house_outside(self):
        ...
        return {
            "type": "Polygon",
            "coordinates": [
                [[79.0808, 21.1403], [79.0815, 21.1403], [79.0815, 21.141], [79.0808, 21.141], [79.0808, 21.1403]]
            ]
        }

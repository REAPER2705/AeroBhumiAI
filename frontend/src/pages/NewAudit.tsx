  ...
  if (step === 'select' || step === 'upload') {
    return (
      <div className="p-8 max-w-4xl mx-auto">
        ...
        <div className="bg-white border-2 border-dashed border-gray-300 rounded-xl p-12 flex flex-col items-center justify-center mb-6">
          <UploadCloud className="w-12 h-12 text-gray-400 mb-4" />
          <p className="font-bold text-gray-700 mb-2">Drag & drop your GeoTIFF file here</p>
          <p className="text-sm text-gray-500 mb-6">or</p>
          <button onClick={() => setStep('draw')} className="bg-green-600 text-white px-6 py-2 rounded-lg font-bold hover:bg-green-700">Browse File</button>
          <button onClick={() => setStep('draw')} className="mt-4 text-xs font-bold text-gray-500 hover:text-green-600 underline">Skip Upload (Use Satellite)</button>
        </div>

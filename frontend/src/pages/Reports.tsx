...
export default function Reports() {
  const [reports] = useState<any[]>([
    { id: 'RPT-2025-018', auditId: 'AUD-2025-018', parcel: 'PLOT-45 (Sector 12)', status: 'Encroachment', date: '24 May 2025 14:32', statusBg: 'bg-rose-950/80 text-rose-300 border-rose-800/60' },
    { id: 'RPT-2025-017', auditId: 'AUD-2025-017', parcel: 'PLOT-12 (Sector 7)', status: 'Clear', date: '24 May 2025 11:20', statusBg: 'bg-emerald-950/80 text-emerald-300 border-emerald-800/60' },
    { id: 'RPT-2025-016', auditId: 'AUD-2025-016', parcel: 'PLOT-21 (Sector 3)', status: 'Variance', date: '23 May 2025 16:15', statusBg: 'bg-amber-950/80 text-amber-300 border-amber-800/60' },
    { id: 'RPT-2025-015', auditId: 'AUD-2025-015', parcel: 'PLOT-09 (Sector 15)', status: 'Clear', date: '23 May 2025 10:10', statusBg: 'bg-emerald-950/80 text-emerald-300 border-emerald-800/60' },
    { id: 'RPT-2025-014', auditId: 'AUD-2025-014', parcel: 'PLOT-33 (Sector 8)', status: 'Clear', date: '22 May 2025 18:30', statusBg: 'bg-emerald-950/80 text-emerald-300 border-emerald-800/60' },
    { id: 'RPT-2025-013', auditId: 'AUD-2025-013', parcel: 'PLOT-27 (Sector 4)', status: 'Encroachment', date: '22 May 2025 12:05', statusBg: 'bg-rose-950/80 text-rose-300 border-rose-800/60' }
  ]);
      ...
      <div className="bg-[#18191c] rounded-xl border border-zinc-800/80 shadow-sm overflow-hidden">
        <div className="p-4 border-b border-zinc-800/80">
          <div className="relative max-w-md">
            ...
            <input type="text" placeholder="Search reports..." className="w-full pl-9 pr-4 py-2 bg-[#121316] border border-zinc-700/80 rounded-lg text-sm text-white placeholder-zinc-500 focus:ring-1 focus:ring-zinc-500" />
          </div>
        </div>
          ...
          <tbody className="divide-y divide-zinc-800/60">
            {reports.map((r, i) => (
              <tr key={i} className="hover:bg-zinc-800/40">
                ...
                <td className="px-6 py-4 text-zinc-300">{r.auditId}</td>
